...
color_palette <- c("#009E73", "#56B4E9", "#C7B900", "#D55E00", "#CC79A7", "#8EBD59", "#663399", "#EB6864")
...
ragg::agg_png(filename = "/g/huber/users/hirschmueller/DECODE/MasterThesis/plots/pseudotime_sup.png",
              width=12, height = 13.5, units="cm",res=500, scaling = 0.4)
combined
dev.off()

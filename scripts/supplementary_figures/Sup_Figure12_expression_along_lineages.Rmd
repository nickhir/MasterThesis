...
plot_pseudotime <- function(gene, extracted_lineages_object, sshot_dataset,
  ...
  p <- p + 
    geom_line(data=curves_df, size=1.2) + 
...
ragg::agg_png(filename = "/g/huber/users/hirschmueller/DECODE/MasterThesis/plots/Sup_fig12_lineages_marker_genes.png",
              width=11.5, height = 13.5, units="cm",res=350, scaling = 0.5)
combined_plot
dev.off()
...
![](/g/huber/users/hirschmueller/DECODE/MasterThesis/plots/Sup_fig12_lineages_marker_genes.png)

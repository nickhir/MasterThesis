---
title: "Supplementary Figure 3 Cell Cycle Scoring"
...
phase_distribution <- ctrl@meta.data %>% 
  ...
  mutate(celltype_manual = factor(celltype_manual, levels = c("aEC","pEC","Copper","mEC", "EE",
                                                              "daEC", "dEC","EB", "ISC")))
...
ragg::agg_png("/g/huber/users/hirschmueller/DECODE/MasterThesis/plots/Sup_fig3_cell_cycle_scoring.png", 
              width = 10, height = 4, res=350, units = "in", scaling = 0.88)
combined
dev.off()
```

![](/g/huber/users/hirschmueller/DECODE/MasterThesis/plots/Sup_fig3_cell_cycle_scoring.png)

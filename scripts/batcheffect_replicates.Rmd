...
ragg::agg_png("/g/huber/users/hirschmueller/DECODE/MasterThesis/plots/batcheffect_replicates.png", width = 15.7, height = 10, res=800, units = "cm", scaling = 0.52)
combined_plots
dev.off()
...
```{r}
rmarkdown::render("/g/huber/users/hirschmueller/DECODE/MasterThesis/scripts/batcheffect_replicates.Rmd", 

---
title: "Figure 4 Differential abundance analysis"
...
```{r}
# create this to give some space for the asterics later. 
dummy= data.frame(celltype = c("AstC-EE", "EEP", "classIII-EE","Tk-EE"), n_cells=c(295,260,190,280), Condition="Control",
...
combined_plot <- wrap_plots(coarse_annotation_plot, plot_spacer(), ee_annotation_plot,
  ...
  theme(plot.tag = element_text(size = 18, face="bold"),
        ...
        legend.text = element_text(size=12.6),
        plot.title = element_text(size=13.5, face="bold",hjust=0.5),
        axis.title = element_text(size=12.5,face="bold"),
        axis.text = element_text(size=12),
        strip.text = element_text(size=12))& 
  guides(color = guide_legend(override.aes = list(size=3),nrow=2,byrow=F))

ragg::agg_png("/g/huber/users/hirschmueller/DECODE/MasterThesis/plots/fig4_differential_abundance_analysis.png", width = 16, height = 9, res=800, units = "cm", scaling = 0.6)
combined_plot
dev.off()

```

![](/g/huber/users/hirschmueller/DECODE/MasterThesis/plots/fig4_differential_abundance_analysis.png)
```{r}
sessionInfo()
```
...
### Introduction
Show the expression of _sff_ and _sc_
...
FeaturePlot(seurat, c("sff","sc"),ncol = 2, pt.size = 0.01, order = T,split.by = "perturbation") 
#&
...
combined<-wrap_plots(celltype_annotation, sff,sc)+
...
ragg::agg_png("/g/huber/users/hirschmueller/DECODE/MasterThesis/plots/sff_sc_expression.png", width = 10, height = 8,
